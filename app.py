...
def sayfa_veri_kalitesi():
    ...
    st.info("💡 Firmanızın veri kaynakları ve veri kalitesine ilişkin metodolojik açıklamaları **Veri Kalitesi** bölümünde detaylandırılabilir. Bu alanın boş bırakılması durumunda, raporda **standart metin** geçerli olacaktır.")
...
def sayfa_raporlama():
    ...
    if st.session_state.get('hesaplama_tamam', False):
            ...
            try:
                ...
                pdf.ln(5)
                pdf.set_font(f_isim, size=12, style='B')
                pdf.cell(190, 8, txt="4.2. Yeşil Su Ayak İzi Hesaplamalari", ln=True)
                pdf.set_font(f_isim, size=10, style='')
                ...
                pdf.set_fill_color(220, 220, 220)
                pdf.cell(95, 8, txt="Veri Kaynağı", border=1, fill=True, align='C')
                pdf.cell(95, 8, txt="Toplam Tüketim (m³/yil)", border=1, ln=True, fill=True, align='C')
                pdf.set_font(f_isim, size=10, style='')
